# 150 Y rep, 15k-20k Y perm, Scenario 6 using WST with 150 RVs/set
n_rv = 150
setwd("C:/Users/JOELLE/Google Drive/Reasearch Mary Sara _ SAMSUNG//C Code//Project/Permutation based methods/Binary trait")

p_vals1=read.table('Results/09-26-2015/With WST/Scenario 6 h20/pvals_20000.txt',header=F)[-(1:15),]
p_vals2=read.table('Results/09-28-2015/With WST/Scenario 6 h20/pvals_20000.txt',header=F)
...
title(expression(paste(" Proportion of variance = 20%")),line=.7)
abline(h=1,col="red")
