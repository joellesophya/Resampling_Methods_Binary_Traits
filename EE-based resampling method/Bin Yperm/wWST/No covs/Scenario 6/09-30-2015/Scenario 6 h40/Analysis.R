...
p_vals1=read.table('Results/09-30-2015/Scenario 6 h40/pvals_20000.txt',header=F)[-(1:7),]
p_vals2=read.table('Results/10-01-2015/Scenario 6 h40a/pvals_20000.txt',header=F)
p_vals3=read.table('Results/10-01-2015/Scenario 6 h40b/pvals_20000.txt',header=F)
...
title(expression(paste(" Proportion of variance = 40%")),line=.7)
abline(h=1,col="red")
