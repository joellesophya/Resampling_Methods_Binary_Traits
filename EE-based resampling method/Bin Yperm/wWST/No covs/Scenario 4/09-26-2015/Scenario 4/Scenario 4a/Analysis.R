...
p_vals1=read.table('Results/09-26-2015/With WST/Scenario 4a/pvals_20000.txt',header=F)
p_vals2=read.table('Results/09-26-2015/With WST/Scenario 4b/pvals_20000.txt',header=F)
...
hist(p_vals, main="Scenario 4 - with Weighted Sum Stat",freq = F,breaks=100, xlab="p value")
