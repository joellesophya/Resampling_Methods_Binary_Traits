...
p_vals1=read.table('Results/09-15-2015/Scenario 6a h40/pvals_25000.txt',header=F)
p_vals2=read.table('Results/09-15-2015/Scenario 6b h40/pvals_25000.txt',header=F)
...
summary(p_vals)
n=length(p_vals);n
hist(p_vals, main="Scenario 6 - Proportion of 40%",freq = F,breaks=100)
