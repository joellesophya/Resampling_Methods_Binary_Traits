...
p_vals4=read.table('Results/10-14-2015/VT/VT - Scenario 6h10a/pvals_20000.txt',header=F)
p_vals5=read.table('Results/10-14-2015/VT/VT - Scenario 6h10b/pvals_20000.txt',header=F)
p_vals6=read.table('Results/10-14-2015/VT/VT - Scenario 6h10c/pvals_20000.txt',header=F)
...
title(expression(paste("Scenario 4 with OLS based VT")),line=2)
