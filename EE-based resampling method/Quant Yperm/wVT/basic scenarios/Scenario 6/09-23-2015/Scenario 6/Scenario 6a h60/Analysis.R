# 100 Y rep, 15k-25k Y perm, Scenario 4 w/ VT
setwd("C:/Users/JOELLE/Google Drive/Reasearch Mary Sara _ SAMSUNG//C Code//Project/Permutation based methods/Binary trait")

p_vals1=read.table('Results/09-23-2015/Scenario 6a h60/pvals_25000.txt',header=F)
p_vals2=read.table('Results/09-23-2015/Scenario 6b h60/pvals_25000.txt',header=F)
p_vals3=read.table('Results/09-23-2015/Scenario 6c h60/pvals_25000.txt',header=F)
p_vals4=read.table('Results/09-23-2015/Scenario 6d h60/pvals_25000.txt',header=F)
...
p_vals=c(p_vals1,p_vals2,p_vals3,p_vals4);rm(p_vals1,p_vals2,p_vals3,p_vals4)

########################### For p_vals from permutation method
summary(p_vals)
n=length(p_vals);n
hist(p_vals, main="Scenario 6 - Proportion of 60%",freq = F,breaks=100, xlab="p value")
