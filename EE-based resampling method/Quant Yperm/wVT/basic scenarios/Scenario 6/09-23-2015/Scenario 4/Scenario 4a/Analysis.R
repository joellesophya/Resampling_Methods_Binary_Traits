...
p_vals1=read.table('Results/09-23-2015/Scenario 4a/pvals_25000.txt',header=F)
p_vals2=read.table('Results/09-23-2015/Scenario 4b/pvals_25000.txt',header=F)
p_vals3=read.table('Results/09-23-2015/Scenario 4c/pvals_25000.txt',header=F)
p_vals4=read.table('Results/09-23-2015/Scenario 4d/pvals_25000.txt',header=F)
