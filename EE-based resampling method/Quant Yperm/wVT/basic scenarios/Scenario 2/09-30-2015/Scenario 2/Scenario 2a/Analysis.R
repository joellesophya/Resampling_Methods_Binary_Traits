...
n_rv= 150
p_vals1=read.table('Results/09-30-2015/Scenario 2a/pvals_20000.txt',header=F)
p_vals2=read.table('Results/09-30-2015/Scenario 2b/pvals_20000.txt',header=F)
p_vals3=read.table('Results/09-30-2015/Scenario 2c/pvals_20000.txt',header=F)
p_vals4=read.table('Results/09-30-2015/Scenario 2d/pvals_20000.txt',header=F)
p_vals5=read.table('Results/09-30-2015/Scenario 2e/pvals_20000.txt',header=F)
...
hist(p_vals, main="Scenario 2 - VT",freq = F,breaks=100, xlab="p value")
title(expression(paste("Sibship correlation: 1%")),line=.7)
abline(h=1,col="red")
...
## MLE estimates
mle1=read.table('Results/09-30-2015/Scenario 2a/mle_est_param.txt',header=F)
mle2=read.table('Results/09-30-2015/Scenario 2b/mle_est_param.txt',header=F)
mle3=read.table('Results/09-30-2015/Scenario 2c/mle_est_param.txt',header=F)
mle4=read.table('Results/09-30-2015/Scenario 2d/mle_est_param.txt',header=F)
mle5=read.table('Results/09-30-2015/Scenario 2e/mle_est_param.txt',header=F)
