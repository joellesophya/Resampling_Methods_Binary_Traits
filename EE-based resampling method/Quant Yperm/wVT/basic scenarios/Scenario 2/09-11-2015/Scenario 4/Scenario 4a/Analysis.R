...
p_vals1=read.table('Results/09-11-2015/Scenario 4a/pvals_25000.txt',header=F)
p_vals2=read.table('Results/09-11-2015/Scenario 4b/pvals_25000.txt',header=F)
...
summary(p_vals)
n=length(p_vals);n
hist(p_vals, main="Scenario 4",freq = F,breaks=100)
