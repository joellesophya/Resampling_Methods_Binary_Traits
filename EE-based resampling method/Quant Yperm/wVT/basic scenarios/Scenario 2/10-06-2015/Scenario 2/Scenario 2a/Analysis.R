...
p_vals4=read.table('Results/10-06-2015/VT - Scenario 2a/pvals_20000.txt',header=F)
p_vals5=read.table('Results/10-06-2015/VT - Scenario 2b/pvals_20000.txt',header=F)
p_vals6=read.table('Results/10-06-2015/VT - Scenario 2c/pvals_20000.txt',header=F)
...
hist(p_vals, main="Scenario 2 - with OLS based VT",freq = F,breaks=100, xlab="p value")
abline(h=1,col="red")
...
title(expression(paste("Scenario 2 with OLS based VT")),line=2)
