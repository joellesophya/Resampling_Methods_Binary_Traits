# Continuous Y with sigma_a=0 to check VT LMM method works
setwd("C:/Users/JOELLE/Google Drive/Reasearch Mary Sara _ SAMSUNG//C Code//Project/Permutation based methods/Binary trait/")
n_rv= 150
p_vals1=read.table('Results/09-29-2015/Scenario 2a/pvals_20000.txt',header=F)
p_vals2=read.table('Results/09-29-2015/Scenario 2b/pvals_20000.txt',header=F)
p_vals3=read.table('Results/09-29-2015/Scenario 2c/pvals_20000.txt',header=F)
p_vals1=unlist(c(p_vals1));names(p_vals1)=c()
p_vals2=unlist(c(p_vals2));names(p_vals2)=c()
p_vals3=unlist(c(p_vals3));names(p_vals3)=c()
p_vals=c(p_vals1,p_vals2,p_vals3);rm(p_vals1,p_vals2,p_vals3)
...
## MLE estimates
mle1=read.table('Results/09-29-15/Scenario 1a/mle_est_param.txt',header=F)
mle2=read.table('Results/09-29-15/Scenario 1b/mle_est_param.txt',header=F)
mle3=read.table('Results/09-29-15/Scenario 1c/mle_est_param.txt',header=F)
mle=rbind(mle1,mle2,mle3); rm(mle1,mle2,mle3)
summary(mle)

## MLE estimates
mle1=read.table('Results/09-29-2015/Scenario 2a/mle_est_param.txt',header=F)
mle2=read.table('Results/09-29-2015/Scenario 2b/mle_est_param.txt',header=F)
mle3=read.table('Results/09-29-2015/Scenario 2c/mle_est_param.txt',header=F)
mle=rbind(mle1,mle2,mle3); rm(mle1,mle2,mle3)
summary(mle)
