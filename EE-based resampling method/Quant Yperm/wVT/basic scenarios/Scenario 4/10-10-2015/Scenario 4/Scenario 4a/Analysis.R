...
p_vals4=read.table('Results/10-10-2015/VT - Scenario 4a/pvals_20000.txt',header=F)
p_vals5=read.table('Results/10-10-2015/VT - Scenario 4b/pvals_20000.txt',header=F)
p_vals6=read.table('Results/10-10-2015/VT - Scenario 4c/pvals_20000.txt',header=F)
...
hist(p_vals, main="Scenario 4 - with OLS based VT",freq = F,breaks=100, xlab="p value")
abline(h=1,col="red")
