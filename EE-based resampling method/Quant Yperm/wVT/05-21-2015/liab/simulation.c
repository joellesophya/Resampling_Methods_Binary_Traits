// LT model : sigma_a^2 = 1, sigma_e^2 = 25

// [[1]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0044   0.0007 0.4355 
// [2,] 0.01  0.0091   0.0009 0.3929 
// [3,] 0.05  0.0469   0.0021 0.1617 

// [[2]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0044   0.0007 0.4355 
// [2,] 0.01  0.009    0.0009 0.3397 
// [3,] 0.05  0.0468   0.0021 0.1484 

// [[3]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0045   0.0007 0.5235 
// [2,] 0.01  0.009    0.0009 0.3397 
// [3,] 0.05  0.0471   0.0021 0.191  
