...
// # Type 1 err rates for 15-25k pvals
// [[1]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0069   0.0008 0.0087 
// [2,] 0.01  0.0155   0.0012 0      
// [3,] 0.05  0.0737   0.0026 0      

// [[2]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0066   0.0008 0.028  
// [2,] 0.01  0.0153   0.0012 0      
// [3,] 0.05  0.0736   0.0026 0      

// [[3]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0072   0.0008 0.0023 
// [2,] 0.01  0.0152   0.0012 0      
// [3,] 0.05  0.0733   0.0026 0   
