...
n_rv= 150
p_vals1=read.table('Results/10-14-2015/VTres/Scenario 2h20a/pvals_20000.txt',header=F)
p_vals2=read.table('Results/10-14-2015/VTres/Scenario 2h20b/pvals_20000.txt',header=F)
p_vals3=read.table('Results/10-14-2015/VTres/Scenario 2h20c/pvals_20000.txt',header=F)
p_vals4=read.table('Results/10-14-2015/VTres/Scenario 2h20d/pvals_20000.txt',header=F)
p_vals5=read.table('Results/10-14-2015/VTres/Scenario 2h20e/pvals_20000.txt',header=F)
...
## MLE estimates
mle1=read.table('Results/10-14-2015/VTres/Scenario 2h20a/mle_est_param.txt',header=F)
mle2=read.table('Results/10-14-2015/VTres/Scenario 2h20b/mle_est_param.txt',header=F)
mle3=read.table('Results/10-14-2015/VTres/Scenario 2h20c/mle_est_param.txt',header=F)
mle4=read.table('Results/10-14-2015/VTres/Scenario 2h20d/mle_est_param.txt',header=F)
mle5=read.table('Results/10-14-2015/VTres/Scenario 2h20e/mle_est_param.txt',header=F)
