...
n_rv= 150
p_vals1=read.table('Results/10-14-2015/VTres/Scenario 4h20a/pvals_20000.txt',header=F)
p_vals2=read.table('Results/10-14-2015/VTres/Scenario 4h20b/pvals_20000.txt',header=F)
p_vals3=read.table('Results/10-14-2015/VTres/Scenario 4h20c/pvals_20000.txt',header=F)
p_vals4=read.table('Results/10-14-2015/VTres/Scenario 4h20d/pvals_20000.txt',header=F)
p_vals5=read.table('Results/10-14-2015/VTres/Scenario 4h20e/pvals_20000.txt',header=F)
# p_vals6=read.table('Results/10-15-2015/Scenario 4h20a/pvals_20000.txt',header=F)
# p_vals7=read.table('Results/10-15-2015/Scenario 4h20b/pvals_20000.txt',header=F)
# p_vals8=read.table('Results/10-15-2015/Scenario 4h20c/pvals_20000.txt',header=F)
...
# p_vals7=unlist(c(p_vals7));names(p_vals7)=c()
# p_vals8=unlist(c(p_vals8));names(p_vals8)=c()
p_vals=c(p_vals1,p_vals2,p_vals3,p_vals4,p_vals5)#,p_vals6,p_vals7,p_vals8)
rm(p_vals1,p_vals2,p_vals3,p_vals4,p_vals5)#,p_vals6,p_vals7,p_vals8)

########################### For p_vals from permutation method
summary(p_vals)
n=length(p_vals);n/n_rv
hist(p_vals, main="Scenario 4",freq = F,breaks=100, xlab="p value")
title(expression(paste("Sibship correlation: 20%")),line=.7)
abline(h=1,col="red")
...
## MLE estimates
mle1=read.table('Results/10-14-2015/VTres/Scenario 4h20a/mle_est_param.txt',header=F)
mle2=read.table('Results/10-14-2015/VTres/Scenario 4h20b/mle_est_param.txt',header=F)
mle3=read.table('Results/10-14-2015/VTres/Scenario 4h20c/mle_est_param.txt',header=F)
mle4=read.table('Results/10-14-2015/VTres/Scenario 4h20d/mle_est_param.txt',header=F)
mle5=read.table('Results/10-14-2015/VTres/Scenario 4h20e/mle_est_param.txt',header=F)
