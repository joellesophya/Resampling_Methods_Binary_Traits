// # 100 Y rep, 15000 Y perm, sigma_a^2=3  with EE logistic model

// > get_type1err(p); get_type1err(pASTOR)
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0046   0.0003 0.2672 
// [2,] 0.01  0.0097   0.0004 0.5742 
// [3,] 0.05  0.049    0.001  0.3297 
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0049   0.0003 0.7273 
// [2,] 0.01  0.0101   0.0004 0.7702 
// [3,] 0.05  0.0508   0.001  0.4416
