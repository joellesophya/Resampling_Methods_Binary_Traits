// # 100 Y rep, 15000 Y perm, sigma_a^2=4  with EE logistic model

// > get_type1err(p); get_type1err(pASTOR)
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0045   0.0003 0.1203 
// [2,] 0.01  0.0089   0.0004 0.0143 
// [3,] 0.05  0.0451   0.0009 0      
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0052   0.0003 0.5899 
// [2,] 0.01  0.0104   0.0005 0.3808 
// [3,] 0.05  0.0491   0.001  0.3721 
