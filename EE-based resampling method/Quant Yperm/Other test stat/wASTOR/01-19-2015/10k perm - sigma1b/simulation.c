// # 100 Y rep
// # 10000 Y perm
// # sigma_a^2=1 using EE with logistic model

// > get_type1err(p); get_type1err(pASTOR)
  // alpha Err_rate   p_value     SE
// 1 0.005   0.0047 0.3579064 0.0003
// 2 0.010   0.0099 0.9105327 0.0004
// 3 0.050   0.0498 0.8134521 0.0010
  // alpha Err_rate   p_value     SE
// 1 0.005   0.0048 0.5055743 0.0003
// 2 0.010   0.0098 0.6693842 0.0004
// 3 0.050   0.0496 0.6590894 0.0010
...
int main(int argc, char **argv) {
	...
	for (i_rep = 1; i_rep <= n_rep; i_rep++){
		...
		for (i = 1; i < data_struct.n_marker; i++){
			...
			fprintf(p_vals_out, "%.7f ", p_vals[i]);
		}
