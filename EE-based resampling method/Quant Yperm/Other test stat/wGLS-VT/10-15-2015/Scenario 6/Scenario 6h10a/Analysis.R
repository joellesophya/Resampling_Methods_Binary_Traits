...
n_rv= 150
p_vals1=read.table('Results/10-15-2015/VTfam no cov - Scenario 6h10a/pvals_20000.txt',header=F)
p_vals2=read.table('Results/10-15-2015/VTfam no cov - Scenario 6h10b/pvals_20000.txt',header=F)
p_vals3=read.table('Results/10-15-2015/VTfam no cov - Scenario 6h10c/pvals_20000.txt',header=F)
p_vals4=read.table('Results/10-15-2015/VTfam no cov - Scenario 6h10d/pvals_20000.txt',header=F)
p_vals5=read.table('Results/10-15-2015/VTfam no cov - Scenario 6h10e/pvals_20000.txt',header=F)
...
hist(p_vals, main="Scenario 6 - GLS-based VT",freq = F,breaks=100, xlab="p value")
...
## MLE estimates
mle1=read.table('Results/10-14-2015/VTres/Scenario 4h10a/mle_est_param.txt',header=F)
mle2=read.table('Results/10-14-2015/VTres/Scenario 4h10b/mle_est_param.txt',header=F)
mle3=read.table('Results/10-14-2015/VTres/Scenario 4h10c/mle_est_param.txt',header=F)
mle4=read.table('Results/10-14-2015/VTres/Scenario 4h10d/mle_est_param.txt',header=F)
mle5=read.table('Results/10-14-2015/VTres/Scenario 4h10e/mle_est_param.txt',header=F)
