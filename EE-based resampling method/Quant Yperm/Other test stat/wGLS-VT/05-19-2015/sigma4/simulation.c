 // 100 Y realizations w/ GLS-VT
 // Phenotype-based ascertainment w/ 6-8 cases/family

// [[1]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0084   0.0013 0.0009 
// [2,] 0.01  0.0168   0.0018 0      
// [3,] 0.05  0.0796   0.0038 0      

// [[2]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0078   0.0013 0.0085 
// [2,] 0.01  0.0163   0.0018 0      
// [3,] 0.05  0.0804   0.0039 0      

// [[3]]
     // alpha Err_rate SE     p_value
// [1,] 0.005 0.0078   0.0013 0.0085 
// [2,] 0.01  0.0167   0.0018 0      
// [3,] 0.05  0.0808   0.0039 0  
