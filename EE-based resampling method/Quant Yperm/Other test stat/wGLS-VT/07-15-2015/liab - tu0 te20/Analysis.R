# EE Binary Y -liab- with pa=0 pe=.2 (only 15k perm)
setwd("C:/Users/JOELLE/Google Drive/Reasearch Mary Sara _ SAMSUNG//C Code//Project/Permutation based methods/Binary trait/")

p_vals=read.table('Results/07-15-15/EE - VT fam - liab - tu0 te20/pvals_15000.txt',header=F)
...
title(expression(paste(pi[u]," = 0, ",pi[e]," = 0.20")),line=.7)
abline(h=1,col="red")
...
title("Observed vs expected -log10 p-values",line=3)
title(expression(paste(pi[u]," = 0, ",pi[e]," = 0.20")),line=2)
