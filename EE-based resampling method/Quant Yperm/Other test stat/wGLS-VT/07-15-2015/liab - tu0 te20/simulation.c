...
// [1,] 0.005 0.008    0.0009 0      
// [2,] 0.01  0.0178   0.0013 0      
// [3,] 0.05  0.0938   0.0029 0 
...
int main(int argc, char **argv) {
	...
	int n_rep = 100, i_rep;
	int perm_num[3] = { 15000, 15000, 15000 };
	//int perm_num[3] = { 10, 20, 30 };
	int n_perm = perm_num[2], i_perm, iter_perm = 0;
	int gen_model = 2; // Which model to use for generating phenotype? 1=logistic (default) vs. 2=liability threshold
