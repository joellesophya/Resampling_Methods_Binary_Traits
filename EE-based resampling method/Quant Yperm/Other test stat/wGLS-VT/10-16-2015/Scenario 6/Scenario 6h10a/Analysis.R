...
n_rv= 150
p_vals1=read.table('Results/10-16-2015/VTfam no cov - Scenario 6h10a/pvals_20000.txt',header=F)
p_vals2=read.table('Results/10-16-2015/VTfam no cov - Scenario 6h10b/pvals_20000.txt',header=F)
p_vals3=read.table('Results/10-16-2015/VTfam no cov - Scenario 6h10c/pvals_20000.txt',header=F)
p_vals4=read.table('Results/10-16-2015/VTfam no cov - Scenario 6h10d/pvals_20000.txt',header=F)
p_vals5=read.table('Results/10-16-2015/VTfam no cov - Scenario 6h10e/pvals_20000.txt',header=F)
